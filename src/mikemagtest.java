...
// An example is provided, as are a couple of helpers to convert inputs to common forms.
    ...
    public class mikemagtest {
        ...
        static class TylerCarter extends StudentAlgorithm{
            public TylerCarter(){super("TylerCarter");}
            public int[] scoreCodewords(String guess, String combo)
                {
                    int amountclose = 0;
                    int amountexact = 0;
                    boolean one = true, two = true, three = true, four = true, bre = false;
